...
// Lucide SVG markup pinned to 658573b0171e693bc965c167592cc0b92d002a3e.
// Pencil adapts Feather v4.29.2 edit-3. Notices: web/public/icons.LICENSE
const paths = {
...
export function icon(name, className = '') {
  ...
  return `<svg class="${attr(classes)}" aria-hidden="true" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">${paths[name] || paths.compass}</svg>`;
}
